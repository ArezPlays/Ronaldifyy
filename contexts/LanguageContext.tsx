...
const translations: Record<LanguageCode, TranslationKeys> = {
  ...
  de: {
    ...
    playSounds: 'Töne bei Aktionen abspielen',
    hapticFeedback: 'Haptisches Feedback',
    vibration: 'Vibration bei Interaktionen',
    language: 'Sprache',
    selectLanguage: 'Sprache auswählen',
    legal: 'Rechtliches',
    privacyPolicy: 'Datenschutzrichtlinie',
    viewPrivacyPolicy: 'Unsere Datenschutzrichtlinie anzeigen',
    termsOfService: 'Nutzungsbedingungen',
    viewTerms: 'Unsere Nutzungsbedingungen anzeigen',
    data: 'Daten',
    resetAppData: 'App-Daten zurücksetzen',
    clearLocalData: 'Lokale Daten löschen und neu beginnen',
    ...
    reset: 'Zurücksetzen',
    delete: 'Löschen',
    contactSupport: 'Um Ihr Konto zu löschen, kontaktieren Sie bitte arezchess@gmail.com',
    ...
    tryFree: '3 Tage kostenlos testen',
    lvl: 'Lvl',
    drillsWord: 'Übungen',
    levels: 'Level',
    unlock: 'Freischalten',
    ...
    beginSession: 'Sitzung beginnen',
    aiCoach: 'KI-Trainer',
    analyze: 'Analysieren',
    recommendedDrills: 'Empfohlene Übungen',
    seeAll: 'Alle anzeigen',
    unlockPotential: 'Entfalte dein volles Potenzial',
    aiVideoAnalysis: 'KI-Videoanalyse • Fortgeschrittene Übungen • Persönliches Coaching',
    aiTip: 'KI-Tipp',
    yourSkills: 'Deine Fähigkeiten',
    drillsCompleted: 'Übungen abgeschlossen',
    startWorkout: 'Workout starten',
    
    // Drills screen
    aiRecommended: 'KI-Empfohlen',
    focusTraining: 'Fokus-Training',
    drillsPersonalized: 'Übungen für deine Ziele personalisiert',
    shootingDrills: 'Schuss-Übungen',
    dribblingDrills: 'Dribbling-Übungen',
    passingDrills: 'Pass-Übungen',
    speedDrills: 'Geschwindigkeits-Übungen',
    fitnessDrills: 'Fitness-Übungen',
    defenseDrills: 'Verteidigungs-Übungen',
    shooting: 'Schießen',
    dribbling: 'Dribbeln',
    passing: 'Passen',
    ...
    unlockMoreDrills: 'Mehr Pro-Übungen freischalten',
    goPro: 'Pro werden',
    skillMastery: 'Fähigkeiten-Meisterschaft',
    progressThroughLevels: 'Durch Level fortschreiten',
    randomWorkout: 'ZUFÄLLIGES WORKOUT',
    mixedSkills: 'Gemischte Fähigkeiten',
    startRandomWorkout: 'Zufälliges Workout starten',
    levelComplete: 'Level abgeschlossen!',
    xpEarned: 'XP verdient!',
    continueTraining: 'Training fortsetzen',
    unlockAllProDrills: 'Alle Pro-Übungen freischalten',
    eliteSkillsAdvanced: 'Elite-Fähigkeiten & fortgeschrittenes Training',
    yourJourney: 'Deine Reise',
    completeAllDrillsEarn: 'Alle Übungen abschließen um zu verdienen',
    drillsInThisLevel: 'Übungen in diesem Level',
    ...
    // Coach screen
    askCoachAnything: 'Frag deinen Trainer...',
    quickStartPrompts: 'Schnellstart',
    improveShootingTip: 'Wie kann ich meinen Schuss verbessern?',
    warmUpRoutineTip: 'Gib mir eine Aufwärmroutine',
    ballControlTip: 'Tipps für bessere Ballkontrolle',
    increaseSpeedTip: 'Wie kann ich schneller werden?',
    personalCoachInfo: 'Ich bin dein persönlicher Fußballtrainer. Frag mich alles über Training, Technik, Taktik oder Fitness!',
    unlockProFeatures: 'Pro-Funktionen freischalten',
    videoAnalysisAdvanced: 'Videoanalyse, fortgeschrittene Übungen & mehr',
    thinking: 'Denkt nach...',
    ...
    selectVideo: 'Wähle ein Video zur Analyse',
    proFeature: 'Pro-Funktion',
    proFeatureDesc: 'Videoanalyse ist eine Pro-Funktion. Upgrade um KI-gestützte Analyse deiner Fußballclips freizuschalten.',
    permissionRequired: 'Berechtigung erforderlich',
    grantAccessMedia: 'Bitte gewähre Zugriff auf deine Medienbibliothek um Videos hochzuladen.',
    uploading: 'Hochladen...',
    analyzing: 'Analysieren...',
    coachAnalysis: 'Trainer-Analyse',
    whatsWorking: 'Was funktioniert',
    workOnThis: 'Daran arbeiten',
    performanceRatings: 'Leistungsbewertungen',
    coachTips: 'Trainer-Tipps',
    recommendedTraining: 'Empfohlenes Training',
    tapToStartTraining: 'Tippe um deine Trainingsreise zu starten',
    startTrainingArrow: 'Training starten →',
    yourAnalyses: 'Deine Analysen',
    whatWeAnalyze: 'Was wir analysieren',
    howItWorks: 'Wie es funktioniert',
    upload: 'Hochladen',
    improve: 'Verbessern',
    important: 'Wichtig',
    uploadDesc: 'Nimm auf oder wähle ein Video aus deiner Galerie (bis zu 60 Sekunden)',
    analyzeDesc: 'Unsere KI überprüft deine Technik, Bewegung und Positionierung',
    improveDesc: 'Erhalte personalisierte Tipps und Übungen für deinen Trainingsplan',
    importantDesc: 'Lade nur Fußball-Clips hoch. Andernfalls kann die KI eine falsche Analyse liefern.',
    unlockVideoAnalysis: 'Videoanalyse freischalten',
    getAiFeedback: 'KI-Feedback zu deiner Technik erhalten',
    analysisFailed: 'Analyse fehlgeschlagen',
    tryAgain: 'Erneut versuchen',
    uploadingVideo: 'Video hochladen...',
    processingFrames: 'Bilder verarbeiten...',
    aiAnalyzing: 'KI analysiert Technik...',
    positioning: 'Positionierung',
    movement: 'Bewegung',
    dribblingMastery: 'Dribbling-Meisterschaft',
    shootingMastery: 'Schuss-Meisterschaft',
    passingMastery: 'Pass-Meisterschaft',
    speedTraining: 'Geschwindigkeitstraining',
    defensiveSkills: 'Defensive Fähigkeiten',
    fitnessProgram: 'Fitness-Programm',
    
    // Auth
    welcomeBack: 'Willkommen zurück',
    signInContinue: 'Melde dich an um dein Training fortzusetzen',
    ...
    backToSocial: 'Zurück zur sozialen Anmeldung',
    enterEmail: 'deine@email.com',
    enterPassword: 'Gib dein Passwort ein',
    
    // Paywall
    unlockFullAccess: 'Vollzugang freischalten',
    ...
    // Paywall
    unlockYourPotential: 'Entfalte dein\nvolles Potenzial',
    trainLikePros: 'Trainiere wie die Profis mit fortgeschrittenem KI-Coaching',
    aiVideoAnalysisFeature: 'KI-Videoanalyse',
    getFeedbackTechnique: 'Erhalte Feedback zu deiner Technik',
    advancedDrillsFeature: 'Fortgeschrittene Übungen',
    proLevelPrograms: '50+ Profi-Trainingsprogramme',
    personalAiCoach: 'Persönlicher KI-Trainer',
    unlimitedCoaching: 'Unbegrenzte Coaching-Sitzungen',
    prioritySupport: 'Prioritäts-Support',
    getHelpNeeded: 'Hilfe bekommen wenn du sie brauchst',
    ...
    subscriptionTerms: 'Mit dem Abonnement stimmst du unseren Nutzungsbedingungen und Datenschutzrichtlinien zu. Abonnements verlängern sich automatisch bis zur Kündigung.',
    welcomeToPro: 'Willkommen bei Pro! 🎉',
    accessAllFeatures: 'Du hast jetzt Zugriff auf alle Premium-Funktionen. Lass uns wie ein Profi trainieren!',
    purchasesRestored: 'Käufe wiederhergestellt',
    proRestored: 'Dein Pro-Abonnement wurde wiederhergestellt.',
    noPurchasesFound: 'Keine Käufe gefunden',
    noPreviousPurchases: 'Wir konnten keine früheren Käufe zum Wiederherstellen finden.',
    purchasesOnDevice: 'Käufe auf Gerät verfügbar',
    purchasesOnlyDevice: 'In-App-Käufe sind nur verfügbar wenn du auf einem echten iOS- oder Android-Gerät mit App Store oder Play Store bist.',
  },
};
...
export const [LanguageProvider, useLanguage] = createContextHook(() => {
  ...
  const loadLanguage = async () => {
    try {
      ...
      if (stored && ['en', 'ar', 'es', 'fr', 'de'].includes(stored)) {
